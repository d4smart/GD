...
class Image
{
     ...
     * @param int $size 文字大小
     * @param array $position 文字位置（x，y），如array(20, 20)
     * @param array $color 文字颜色（R，G，B），如array(255, 255, 255)
     * @param int $alpha 文字透明度，0-100
     ...
     * @param array $position 水印位置，如array(30, 20)
    ...
    public function imageMark($source, $position, $alpha) {
        ...
        // 添加水印
        imagecopymerge($this->image, $waterImage, $position[0], $position[1], 0, 0, $info[0], $info[1], $alpha);
